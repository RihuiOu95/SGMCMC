function [unif_log_pred, clu_log_pred] = tuning_eval(trans_chain_alex_clus_uninfo, trans_chain_unif, emit_chain_alex_clus_uninfo, emit_chain_unif, y_test, n_mcmc)
    indices = identify_brust_region(y_test, 1.0, 10);
    breakpts = n_mcmc;
